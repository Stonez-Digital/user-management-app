...
export default function LoginPage() {
 ...
 async function login(e:React.FormEvent){
  ...
  try {
   ...
   localStorage.setItem("access_token",d.access_token); localStorage.setItem("refresh_token",d.refresh_token); const me=await fetch("/backend/me",{headers:{Authorization:"Bearer "+d.access_token}}); const user=await me.json(); router.push(user?.role==="parent"?"/parent":"/dashboard");
