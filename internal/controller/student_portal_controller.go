...
func(ctrl *StudentPortalController)Terms(c *gin.Context){id,ok:=ctrl.uid(c);if !ok{return};v,e:=ctrl.service.Terms(id);if e!=nil{studentPortalError(c,e);return};c.JSON(http.StatusOK,v)}
