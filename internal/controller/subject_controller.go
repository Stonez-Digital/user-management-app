...
func(ctrl *SubjectController)Delete(c *gin.Context){id,e:=uuid.Parse(c.Param("id"));if e!=nil{httpx.Error(c,400,"invalid_subject_id","invalid subject id");return};if e=ctrl.service.Delete(schoolID,id);e!=nil{subjectError(c,e);return};actor,_:=uuid.Parse(c.GetString("user_id"));_=audit.Record(ctrl.service.DB(),c,&actor,"subject.delete","subject",&id,nil);c.JSON(200,gin.H{"message":"subject deleted"})}