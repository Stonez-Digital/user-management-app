...
type GuardianRelationship struct {
    ...
    GuardianUserID uuid.UUID `gorm:"type:uuid;not null;index;uniqueIndex:ux_guardian_student" json:"guardian_user_id"`
    StudentID uuid.UUID `gorm:"type:uuid;not null;index;uniqueIndex:ux_guardian_student" json:"student_id"`
