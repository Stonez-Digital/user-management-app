...
type Subject struct {
 ...
 Code string `gorm:"size:30;not null;uniqueIndex:uq_school_subject_code" json:"code"`
 Name string `gorm:"size:100;not null;uniqueIndex:uq_school_subject_name" json:"name"`
