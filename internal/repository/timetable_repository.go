...
type TimetableRepository interface { Create(models.TimetableEntry)(models.TimetableEntry,error); List()([]models.TimetableEntry,error); Get(uuid.UUID)(models.TimetableEntry,error); Update(models.TimetableEntry)error; Delete(uuid.UUID)error }
