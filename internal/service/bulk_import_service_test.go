...
func bulkTestDB(t *testing.T)*gorm.DB{t.Helper();db,e:=gorm.Open(sqlite.Open("file:"+t.Name+"?mode=memory&cache=shared"),&gorm.Config{});if e!=nil{t.Fatal(e)};if e=db.AutoMigrate(&models.School{},&models.User{},&models.Student{},&models.StudentEnrollment{},&models.GuardianRelationship{},&models.AcademicSession{},&models.SchoolClass{},&models.Section{},&models.BulkImportJob{},&models.BulkImportRow{},&models.TeacherProfile{},&models.ParentProfile{});e!=nil{t.Fatal(e)};return db}
